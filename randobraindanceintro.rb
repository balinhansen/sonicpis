...
notesa=(scale :Fs3, :minor_pentatonic,num_octaves: 2).shuffle
...
define :randokey do
  2.times do
    synth :sine, note: :e3, sustain: 0.875, release: 0.25, note_slide: 0.0625, amp: 0.3
    #tick_reset
    7.times do
      synth :sine, note: notesa.tick
      sleep 0.125
    end
    sleep 0.125
  end
  ...
  2.times do
    synth :saw, note: :e4, sustain: 0.875, release: 0.25, note_slide: 0.0625, amp: 0.3
    #tick_reset
    7.times do
      synth :saw, note: notesa.tick+12
      sleep 0.125
    end
    sleep 0.125
  end
  ...
  2.times do
    synth :square, note: :e4, sustain: 0.875, release: 0.25, note_slide: 0.0625, amp: 0.3
    #tick_reset
    7.times do
      synth :square, note: notesa.tick+12
      sleep 0.125
    end
    sleep 0.125
  end
